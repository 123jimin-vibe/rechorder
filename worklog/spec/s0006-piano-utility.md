...
- Dragging along a row scrolls that row in every orientation without releasing its starting note; that note continues until the pointer ends or cancels. A stationary finger may keep playing on one row while another finger scrolls the other. Touch, pointer and wheel scrolling respect the rotated keyboard axis.

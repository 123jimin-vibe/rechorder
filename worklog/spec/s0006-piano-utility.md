...
- Dragging along a row scrolls that row in every orientation without releasing its starting note; that note continues until its input contact ends or cancels. Touch contacts retain independent note and scrolling lifecycles even if the browser cancels their compatibility pointer stream, so ending or cancelling one finger never releases another. A stationary finger may keep playing on the same row or one row while another finger scrolls. Touch, pointer and wheel scrolling respect the rotated keyboard axis.
